...
//    }
    private val viewModel by lazy {
        ...
        val formularioNoticiaViewModelFactory = FormularioNoticiaViewModelFactory(repository)
        val provedor = ViewModelProvider(this, formularioNoticiaViewModelFactory)
